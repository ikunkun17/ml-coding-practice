...
# stripplot( ) 그리기
sns.stripplot(x='day', y='tip', hue='sex', data=tips, alpha=0.8, ax=ax1)

# swarmplot( ) 그리기
sns.swarmplot(x='day', y='tip', hue='sex', data=tips, palette='Set2', alpha=0.8, ax=ax2)
...
plt.suptitle('Pairplot with Histograms by Gender', y=1.10)
